        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {platformCards.map((card) => (
            <article
              ...
              className="group relative flex h-full flex-col overflow-hidden rounded-[2rem] border border-slate-800/80 bg-slate-900/80 p-7 shadow-2xl shadow-cyan-900/10 transition-transform duration-500 hover:-translate-y-1"
            >
              ...
              <div className="relative z-10 flex items-start justify-between gap-4 mb-8">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-800/90 text-cyan-300 shadow-lg shadow-cyan-500/10">
                  {card.icon}
                </div>
                {card.badge ? (
