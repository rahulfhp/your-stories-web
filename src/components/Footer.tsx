  ...
  return (
    <footer className="w-full relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-16 xl:px-[8.83rem] py-8 sm:py-12 lg:py-[3rem] flex flex-col justify-between gap-8">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto">
            <div className="flex flex-col gap-3 sm:gap-4 items-center lg:items-start">
              ...
              <div className="relative w-40 sm:w-48 lg:w-[15.63rem] h-10 sm:h-12 lg:h-[4.02rem]">
                ...
                {/* <Image
                  src="/mindefy-light-logo.svg"
                  alt="Mindefy Technologies Logo"
                  fill
                  className="object-contain block dark:hidden"
                />
                <Image
                  src="/mindefy-dark-logo.svg"
                  alt="Mindefy Technologies Logo"
                  fill
                  className="object-contain dark:block hidden"
                /> */}
        ...
        {/* Footer Bottom */}
        <div className="text-center text-xs sm:text-sm opacity-80 text-gray-800 dark:text-white">
          &copy; {getYear} Mindefy Technologies. All rights reserved.
        </div>
      </div>
    </footer>
  );
