export default function PrivacyPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-black dark:via-gray-900 dark:to-black pt-24">
      <div className="text-center px-4">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-white/60">
          Main Domain Privacy Policy Page
        </p>
