        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/90 dark:bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl border border-gray-300/80 dark:border-white/20 p-4 sm:p-6 lg:p-8 shadow-2xl dark:shadow-none space-y-6 sm:space-y-8">
            ...
            {visibleSections.facebookLink && (
              <div className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-300/60 dark:border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:bg-white/90 dark:hover:bg-white/15 transition-all duration-300">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <label className="text-gray-800 dark:text-white font-medium text-sm sm:text-base">Facebook Handle</label>
                </div>
                <input
                  type="url"
            ...
            {visibleSections.twitterLink && (
              <div className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-300/60 dark:border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:bg-white/90 dark:hover:bg-white/15 transition-all duration-300">
                <div className="flex items-center space-x-3 mb-2">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-sky-500" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                  </svg>
                  <label className="text-gray-800 dark:text-white font-medium text-sm sm:text-base">Twitter/X Handle</label>
                </div>
                <input
                  type="url"
            ...
            {visibleSections.instagramLink && (
              <div className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-300/60 dark:border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:bg-white/90 dark:hover:bg-white/15 transition-all duration-300">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <label className="text-gray-800 dark:text-white font-medium text-sm sm:text-base">Instagram Handle</label>
                </div>
                <input
                  type="url"
            ...
            <div className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-300/60 dark:border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:bg-white/90 dark:hover:bg-white/15 transition-all duration-300">
              ...
              {selectedTags.length > 0 && (
                <div className="mt-3 sm:mt-4 flex flex-wrap items-center gap-2">
                  <span className="text-gray-600 dark:text-white/70 text-xs sm:text-sm">Selected:</span>
                ...
                <div className="max-h-64 sm:max-h-96 overflow-y-auto custom-scrollbar">
                  {isLoadingImages ? (
                    <div className="flex items-center justify-center py-8 sm:py-12">
                      ...
                      <span className="ml-2 sm:ml-3 text-sm sm:text-base text-gray-600 dark:text-white/70">Searching for images...</span>
                    </div>
