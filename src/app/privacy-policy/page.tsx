...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="bg-[#f3f4f6] min-h-screen pb-12 pt-22 md:pt-25 lg:pt-30 md:pb-12 px-4 md:px-8 flex justify-center">
      ...
      <section className="bg-white rounded-lg shadow-xl p-5 md:p-8 max-w-4xl min-h-[70rem]">
        ...
        {/* Section Heading */}
        <h4 className="text-2xl mb-4 font-semibold text-[#23AAE2] font-montserrat">
          Overview
        </h4>
