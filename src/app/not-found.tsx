...
export default function NotFound() {
  ...
  return (
    // LIGHT MODE ONLY IF WEBSITE
    <div
      className={
        isWebsite
          ? "min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden"
          ...
          <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center">
            ...
            <div className="bg-white/30 backdrop-blur-2xl rounded-3xl p-8 sm:p-10 lg:p-12 border border-white/40 shadow-[0_20px_40px_rgba(0,0,0,0.15)] ring-1 ring-white/20 max-w-2xl w-full mx-auto">
              ...
              <div className="mb-8 sm:mb-10">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 font-montserrat">
                  Oops! Page Not Found
                </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <button
                  ...
                  className="bg-white/40 backdrop-blur-2xl cursor-pointer border border-white/60 hover:bg-white/60 hover:border-white/80 text-gray-800 font-semibold py-3 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] shadow-[0_8px_32px_rgba(0,0,0,0.1)] ring-1 ring-white/20 w-full sm:w-auto"
                >
                  🏠 Go Home
                </button>
              </div>
            ...
            <div className="absolute top-20 left-10 w-4 h-4 bg-white/20 rounded-full animate-bounce delay-300 hidden lg:block"></div>
            <div className="absolute bottom-32 right-16 w-6 h-6 bg-white/15 rounded-full animate-bounce delay-700 hidden lg:block"></div>
            <div className="absolute top-40 right-20 w-3 h-3 bg-white/25 rounded-full animate-bounce delay-500 hidden lg:block"></div>
          </div>
        </div>
      ) : (
